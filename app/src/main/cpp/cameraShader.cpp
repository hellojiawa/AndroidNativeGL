...
void drawFrame(void *ins, const float dataVertex[12], const float dataTexCoor[8]) {
    //清除深度缓冲,颜色缓冲
...
void bindTexture(GLenum texture_n, GLuint texture_id, GLsizei width, GLsizei height,
                 const void *buffer) {
    //处理纹理
    //		2.绑定纹理
